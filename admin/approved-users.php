        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All approved Users</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <?php echo $user->viewApprovedUsers(); ?>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
<script type="text/javascript">
    ...
    $('.unapprove').click(function(e){
        ...
        swal({
        title: "Are you sure?",
        text: "Are you sure you want to Unapprove this User",
        type: "warning",
       ...
       window.location = 'controllers/processors/unapprove_user.php?id='+id;
    });
