				...
				$this->filename = $new_file_name;
				  ...
				  $this->size       = $file['size'];
				   ...
				   if(empty($this->filename) || empty($this->temp_path)) {
						  $_SESSION['error'] = "The location to save the document is not available. Contact Admin";
						  return false;
					
					  }
					 $this->ext = strtolower(pathinfo($file['name'], PATHINFO_EXTENSION));
					  $this->pic_file = $this->target . $this->file_name. "." .$this->ext;
					 if (( $this->ext != "doc")  && ( $this->ext != "docx") && ( $this->ext != "jpg") && ( $this->ext != "png") && ( $this->ext != "JPEG") && ( $this->ext != "pdf") && ( $this->ext != "ppt") 
					 && ( $this->ext != "mp4")&&( $this->ext != "mp3")&& ( $this->ext != "htm")&& ( $this->ext != "html")&& ( $this->ext != "xlsx") && ( $this->ext != "xls")
					 && ( $this->ext != "ppt")) 
								{
