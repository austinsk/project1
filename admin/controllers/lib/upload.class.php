				...
				$this->filename = $new_file_name;
				  ...
				  $this->size       = $file['size'];
				   ...
				   if(empty($this->filename) || empty($this->temp_path)) {
					 ...
					 if (( $this->ext != "doc") &&( $this->ext != "jpg") && ( $this->ext != "docx")&& ( $this->ext != "png") && ( $this->ext != "pdf") && ( $this->ext != "ppt") && ( $this->ext != "pptx")) 
								{
		 ...
		 return "error";
			...
			if(move_uploaded_file($this->temp_path,$this->pic_file)) {
		  	//
				...
				// File was not moved.
		     $_SESSION['status'] = "Failed to Save Application. Pls Try Again";
			 return "error";
